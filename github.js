class GitHub {
  ...
  async getUser(userName) {
    ...
    const repoResponse = await fetch(`${this.base_url}/${userName}/repos?per_page=${this.repo_count}&sort=${this.sort_order}&client_id=${this.client_id}&client_secret=${this.client_secret}`)
